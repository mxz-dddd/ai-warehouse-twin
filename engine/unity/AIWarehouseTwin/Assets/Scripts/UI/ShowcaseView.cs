...
namespace AIWarehouseTwin.UI
{
    public sealed class ShowcaseView : MonoBehaviour
    {
        ...
        private VisualElement _abComparePanel;
        ...
        private VisualElement _kpiHudA;
        ...
        private VisualElement _kpiHudB;
        ...
        private void BindElements(VisualElement root)
        {
            ...
            _abComparePanel = root.Q<VisualElement>("ab-compare-panel");
            ...
            _kpiHudA    = root.Q<VisualElement>("kpi-hud-a");
            ...
            _kpiHudB    = root.Q<VisualElement>("kpi-hud-b");
